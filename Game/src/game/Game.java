...
papich = ImageIO.read(Game.class.getResourceAsStream("/cat.png"));
nuts = ImageIO.read(Game.class.getResourceAsStream("/klubok.png"));
end = ImageIO.read(Game.class.getResourceAsStream("/cat.png"));
game_game = new Game();
